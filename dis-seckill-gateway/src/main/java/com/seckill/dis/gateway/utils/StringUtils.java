...
//
//    private static final Map<String, Pair<Character,Integer>> BRACKET_COUPLE = new HashMap<>();
//
//    static {
//        BRACKET_COUPLE.put("{" ,Pair.make('}',1));
//        BRACKET_COUPLE.put("[" ,Pair.make(']',1));
//        BRACKET_COUPLE.put("\"",Pair.make('\"',1));
//        BRACKET_COUPLE.put("(" ,Pair.make(')',1));
//        BRACKET_COUPLE.put("<" ,Pair.make('>',1));
...
//
//    /**
//     * 括号配对，如果传入左边括号，返回对应右半边括号，1；如果传入的不是括号类型，返回null，0；如果传入的是右边括号，返回对应左半边括号，-1；
//     * @param halfBracket 半边括号
//     * @return <括号字符，标识位>
//     */
//    public static Pair<Character,Integer> coupleBrackets(char halfBracket){
//        if(BRACKET_COUPLE.containsKey(halfBracket + "")){
//            return BRACKET_COUPLE.get(halfBracket + "");
//        }
//        return Pair.make(halfBracket,0);
//    }
//}
