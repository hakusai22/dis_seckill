...
public class OrderController {
    ...
    @ResponseBody
    public String deleteOrder(@RequestParam("id") long id, Model model, HttpServletResponse response, HttpServletRequest request, UserVo user) throws ParseException {
