...
public class GoodsController {
    ...
    @ResponseBody
    public String deleteGoods(@RequestParam("goodsId") long goodsId,Model model,HttpServletResponse response,HttpServletRequest request,UserVo user) throws ParseException {
    ...
    @ResponseBody
    public String updateGoods(@RequestParam("goodsId") long goodsId,Model model,HttpServletResponse response,HttpServletRequest request,UserVo user) throws ParseException {
    ...
    @RequestMapping(value = "aminGoodsList", produces = "text/html")// produces表明：这个请求会返回text/html媒体类型的数据
    @ResponseBody
