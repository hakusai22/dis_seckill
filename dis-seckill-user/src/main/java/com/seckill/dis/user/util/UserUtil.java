...
public class UserUtil {
   ...
   */
  private static void generateMiaoshaUserList(int count,
      List<SeckillUser> users) {
   ...
   * @throws SQLException
   */
  private static void insertSeckillUserToDB(
      List<SeckillUser> users) throws ClassNotFoundException, SQLException {
